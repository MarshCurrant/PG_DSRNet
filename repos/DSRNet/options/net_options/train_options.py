...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--nEpochs', '-n', type=int, default=50, help='# of epochs to run')
        ...
        self.parser.add_argument('--lambda_freq', type=float, default=0.0, help='weight for frequency loss')
        self.parser.add_argument('--lambda_prior', type=float, default=0.0, help='weight for prior-weighted residual loss')
        self.parser.add_argument('--prior_source', type=str, default='target_r',
                                 choices=['target_r', 'input_minus_t'],
                                 help='source for reflection prior map')
        self.parser.add_argument('--freq_levels', type=int, default=3, help='number of frequency decomposition levels')
